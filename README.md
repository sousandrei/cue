...
*   **Automatic Setup:** On first launch, Cue automatically downloads its required dependencies (`yt-dlp`, `ffmpeg`, `bun`, and `yt-dlp-ejs`) to ensure everything works out of the box.
